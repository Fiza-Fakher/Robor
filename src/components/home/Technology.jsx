...
function Technology() {
  ...
  return (
    <>
      <section className='bg-purple-500 w-full text-white flex flex-col justify-center items-center pt-20 pb-70 md:pb-70 sm:pb-10 relative'>
        ...
        <div className="flex justify-center items-center gap-8 flex-wrap py-4">
          {techCards.map((items, index) => (
            <div
              key={index}
              className="w-80 h-70 rounded-2xl 
